...
#define ESPNOW_ID 4567
#define SINGLE_TAP_DURATION    1000 // 0 to disable, else delay in ms
int bat_level = 0;
...
void my_data_populate(my_data_t *data){
    ...
    data->id = ESPNOW_ID;
    data->value = 1;
    data->battery_level = bat_level;
    data->single_tap_duration = SINGLE_TAP_DURATION;
}
...
int app_main(){
    ...
    // esp_deep_sleep_enable_timer_wakeup(10000);
